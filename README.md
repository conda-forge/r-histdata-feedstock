...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-histdata-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-histdata-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install r-histdata
```
...
It is possible to list all of the versions of `r-histdata` available on your platform:
...
```
pixi search r-histdata --channel conda-forge
```
